...
<head>
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-2SNRFH7YVH"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());
    
        gtag('config', 'G-2SNRFH7YVH');
    </script>
    ...
    <link rel="icon" type="image/png" href="/static/image/favicon-16x16.png">
    <style>
        * {
            margin: 0px;
        }
...
<body>
    ...
    <script async src="https://app3.weatherwidget.org/js/?id=ww_7367f5689bf4c"></script>
        ...
        <div class="title_div">
            ...
            <div class="title_image"><a style="text-decoration: none;" href="https://www.holcim.pl/" target="_blank">
                <img id="logo" src="static/image/holcim_logo_color.svg" alt="logo" xmlns="http://www.w3.org/2000/svg" width="284" height="67" fill="none">
    ...
    <footer style="margin-top: 3px; margin-bottom: 3px; text-align: center; font-size: small;">
            <p> ⓒ production by Ilin Maksim <br> ilin1980maks@gmail.com</p>
    </footer>
</body>
